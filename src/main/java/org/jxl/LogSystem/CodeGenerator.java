...
public class CodeGenerator {
    ...
    static {
        ...
        //InputStream i = CodeGenerator.class.getResourceAsStream("/src/main/resources/mybatis-plus.properties");
        try {
            //properties.load(i);
            projectPackage = "org.jxl.LogSystem";
            controllerPackage = "controller";
            entityPackage = "model";
            url = "jdbc:mysql://127.0.0.1:3306/log_system?useSSL=false&useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull";
            username = "root";
            password = "root";
    ...
    public static void main(String[] args) {
        ...
        focList.add(new FileOutConfig(entityPath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                // 自定义输出文件名 ， 如果你 Entity 设置了前后缀、此处注意 xml 的名称会跟着发生变化！！
                return projectPath + "/src/main/java/" + javaPath + "/model/" + tableInfo.getEntityName() + fileSuffix;
            }
        ...
        strategy.setInclude("warn_management");
